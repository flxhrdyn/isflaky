...
# Groq has retired both.
_DEFAULT_MODEL = "openai/gpt-oss-120b"

# This is a reasoning model: it spends several hundred tokens thinking before
# emitting the JSON, so a budget sized to the answer alone truncates it away.
_MAX_TOKENS = 1024
_UNKNOWN = 0.5
_SYSTEM = (
